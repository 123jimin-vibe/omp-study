...
export const responseComparisonExample: ResponseComparisonBlock = {
  ...
  prompt: {
    label: '동일한 요청',
    text: '점수 배열의 평균을 구하는 averageScore(scores)를 JavaScript로 작성해 줘. 항목은 0 이상의 유한한 수, null, undefined 중 하나야. null과 undefined만 빼고 0은 포함해. 남은 점수가 없으면 null을 반환해.',
  },
  candidates: [
    {
      label: '가능한 응답 A',
  ...
  return sum / valid.length;
      ...
      explanation: 'null과 undefined만 제외해 0점을 남깁니다. [0, 100]의 합계 100을 두 점수로 나누어 평균 50을 구합니다.',
    },
  ],
  checks: [
