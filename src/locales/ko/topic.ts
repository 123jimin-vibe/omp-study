        ...
        sections: [
          ...
          },
          {
            ...
            blocks: [
              ...
              {
                kind: 'paragraph',
                text: '두 구현 모두 `[80, 100]`에서는 90을 반환합니다. 하지만 `[0, 100]`의 평균은 50이어야 하는데, A는 100을, B는 50을 반환합니다. 0점을 포함한 검사가 이 차이를 드러냅니다.',
              },
              {
                kind: 'paragraph',
